...
/**
 * A JUnit {@link Rule @Rule} which launches an mActivity when your test starts. Stop extending
 ...
 * }</pre>
 *
 * This will automatically launch the mActivity for each test method. The instance will also be
 * created sooner should you need to use it in a {@link Before @Before} method.
 * <p>
 * You can also customize the way in which the mActivity is launched by overriding
...
public class ActivityRule<T extends Activity> implements TestRule {
    ...
    /**
     * Get the running instance of the specified mActivity. This will launch it if it is not already
     * running.
     */
    public final T get() {
        launchActivity();
